...
DESCRIPTION="youtube on the command line"
HOMEPAGE="https://github.com/trizen/pipe-viewer"
SRC_URI="https://github.com/trizen/pipe-viewer/archive/${PV}.tar.gz -> ${P}.tar.gz"
RESTRICT="mirror"
LICENSE="Artistic-2"
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="gtk yt-dlp readline"
...
pkg_postinst() {
	...
	optfeature "For the *_parallel config-options" dev-perl/Parallel-ForkManager
	elog
